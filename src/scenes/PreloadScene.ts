...
export class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('path1', 'assets/tiles/kenney/towerDefense_tile005.png'); // full brown fill
    this.load.image('path2', 'assets/tiles/kenney/towerDefense_tile006.png'); // full brown variant
